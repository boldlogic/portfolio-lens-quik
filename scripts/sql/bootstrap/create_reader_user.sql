...
DECLARE @login_name SYSNAME = N'quik_portfolio_reader';
DECLARE @user_name SYSNAME = N'u_quik_portfolio_reader';
DECLARE @role_name SYSNAME = N'quik_portfolio_reader';
