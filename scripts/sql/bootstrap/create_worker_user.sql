...
DECLARE @login_name SYSNAME = N'quik_portfolio_worker';
DECLARE @user_name SYSNAME = N'u_quik_portfolio_worker';
DECLARE @role_name SYSNAME = N'quik_portfolio_worker';
