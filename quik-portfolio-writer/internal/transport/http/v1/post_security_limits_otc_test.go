	...
	tests := []struct {
		...
		},
		{
			...
			req: httptest.NewRequest(http.MethodPost, exampleURL, bytes.NewBufferString(
				`{"clientCode":"AB12CD","ticker":"OTC_BOND","firmCode":"NC0058900000","balance":1,"acquisitionCcy":"USD"}`,
			)),
			wantBody:   nil,
		...
		},
		{
			...
			req:        reqJSON(`{"clientCode":"","ticker":"OTC_BOND","firmCode":"NC0058900000","balance":1,"acquisitionCcy":"USD"}`),
			wantBody:   nil,
		...
		},
		{
			...
			req:        reqJSON(`{"clientCode":"1234567890123","ticker":"OTC_BOND","firmCode":"NC0058900000","balance":1,"acquisitionCcy":"USD"}`),
			wantBody:   nil,
			wantDetail: "clientCode",
			wantErr:    models.ErrValidation,
		},
		{
			name:       "пустой_ticker",
			req:        reqJSON(`{"clientCode":"AB12CD","ticker":"","firmCode":"NC0058900000","balance":1,"acquisitionCcy":"USD"}`),
			wantBody:   nil,
			wantDetail: "ticker",
			wantErr:    models.ErrValidation,
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","ticker":"OTC_BOND","firmCode":"","balance":1,"acquisitionCcy":"USD"}`),
			wantBody:   nil,
			wantDetail: "firmCode",
			wantErr:    models.ErrValidation,
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","ticker":"OTC_BOND","firmCode":"NC0058900000","balance":1,"acquisitionCcy":"USD","tradeAccount":"L01-00000F00"}`),
			wantBody:   nil,
		...
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","ticker":"SBERLONGTICKER","firmCode":"NC0058900000","balance":1,"acquisitionCcy":"USD"}`),
			wantBody:   nil,
			wantDetail: "ticker",
			wantErr:    models.ErrValidation,
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","ticker":"OTC_BOND","firmCode":"NC00589000001","balance":1,"acquisitionCcy":"USD"}`),
			wantBody:   nil,
			wantDetail: "firmCode",
			wantErr:    models.ErrValidation,
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","ticker":"OTC_BOND","settleCode":"123456","firmCode":"NC0058900000","balance":1,"acquisitionCcy":"USD"}`),
			wantBody:   nil,
		...
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","ticker":"OTC_BOND","firmCode":"NC0058900000","balance":1,"acquisitionCcy":"USDD"}`),
			wantBody:   nil,
		...
		{
			name:       "isin_длина_>12",
			req:        reqJSON(`{"clientCode":"AB12CD","ticker":"OTC_BOND","firmCode":"NC0058900000","balance":1,"acquisitionCcy":"USD","isin":"RU000A0JX0J2X"}`),
			wantBody:   nil,
			wantDetail: "isin",
			wantErr:    models.ErrValidation,
		},
