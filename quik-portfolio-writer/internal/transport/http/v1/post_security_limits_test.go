	...
	tests := []struct {
		...
		},
		{
			...
			req: httptest.NewRequest(http.MethodPost, exampleURL, bytes.NewBufferString(
				`{"clientCode":"AB12CD","secCode":"SBER","tradeAccount":"L01-00000F00","firmCode":"NC0058900000","balance":1}`,
			)),
			wantBody:   nil,
		...
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","secCode":"SBER","tradeAccount":"","firmCode":"NC0058900000","balance":1}`),
			wantBody:   nil,
		...
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","secCode":"SBER","tradeAccount":"L01-00000F000","firmCode":"NC0058900000","balance":1}`),
			wantBody:   nil,
			wantDetail: "tradeAccount",
			wantErr:    models.ErrValidation,
		},
		{
			...
			req:        reqJSON(`{"clientCode":"","secCode":"SBER","tradeAccount":"L01-00000F00","firmCode":"NC0058900000","balance":1}`),
			wantBody:   nil,
		...
		},
		{
			...
			req:        reqJSON(`{"clientCode":"1234567890123","secCode":"SBER","tradeAccount":"L01-00000F00","firmCode":"NC0058900000","balance":1}`),
			wantBody:   nil,
			wantDetail: "clientCode",
			wantErr:    models.ErrValidation,
		},
		{
			name:       "пустой_ticker",
			req:        reqJSON(`{"clientCode":"AB12CD","secCode":"","tradeAccount":"L01-00000F00","firmCode":"NC0058900000","balance":1}`),
			wantBody:   nil,
			wantDetail: "secCode",
			wantErr:    models.ErrValidation,
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","secCode":"SBER","tradeAccount":"L01-00000F00","firmCode":"","balance":1}`),
			wantBody:   nil,
			wantDetail: "firmCode",
			wantErr:    models.ErrValidation,
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","secCode":"SBERLONGTICKER","tradeAccount":"L01-00000F00","firmCode":"NC0058900000","balance":1}`),
			wantBody:   nil,
			wantDetail: "secCode",
			wantErr:    models.ErrValidation,
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","secCode":"SBER","tradeAccount":"L01-00000F00","firmCode":"NC00589000001","balance":1}`),
			wantBody:   nil,
			wantDetail: "firmCode",
			wantErr:    models.ErrValidation,
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","secCode":"SBER","tradeAccount":"L01-00000F00","settleCode":"123456","firmCode":"NC0058900000","balance":1}`),
			wantBody:   nil,
		...
		},
		{
			...
			req:        reqJSON(`{"clientCode":"AB12CD","secCode":"SBER","tradeAccount":"L01-00000F00","firmCode":"NC0058900000","balance":1,"acquisitionCurrencyCode":"USDD"}`),
			wantBody:   nil,
		...
		{
			name:       "isin_длина_>12",
			req:        reqJSON(`{"clientCode":"AB12CD","secCode":"SBER","tradeAccount":"L01-00000F00","firmCode":"NC0058900000","balance":1,"isin":"RU000A0JX0J2X"}`),
			wantBody:   nil,
			wantDetail: "isin",
			wantErr:    models.ErrValidation,
		},
